...
export const listGlobalFeedValidator = [
  query("page")
    .optional()
    .isInt({ min: 1 })
...
export const createGlobalPostValidator = [
  body("content")
    .notEmpty()
  ...
  body("postType")
    ...
    .withMessage("postType must be either post or announcement"),
...
export const createGlobalPostCommentValidator = [
  param("postId").isMongoId().withMessage("Invalid post ID"),
